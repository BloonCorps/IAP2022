...
theta = thetas[0:144]
F = thetas[-1]
with open('../output/contrastive_learning_Up/learned_Up_beta%.3f_basin2_theta.pkl'%beta, 'wb') as file_handle:
    pickle.dump({'theta': theta, 'logZ': F}, file_handle)

## directly extract trained parameters
# with open('../output/contrastive_learning_Up_basin1/learned_Up_beta%.3f_basin1_theta.pkl'%beta, 'rb') as file_handle:
