...
#         print('idx_step: %d ....\n'%idx_step)
    ...
    if idx_step in num_steps:
        with torch.no_grad():
            ...
            loss_valid = torch.mean(ubmx - uax_valid - beta**(-1)*logdetm)
        ...
        torch.save({'loss_train': loss.item(),
                    ...
                    '../output/LFEP/model_basin1_beta%.3f_step%d.pt'%(beta, idx_step))

## store training and validation loss
with open('../output/LFEP/loss_record_basin1_beta%.3f.pkl'%beta, 'wb') as file_handle:
